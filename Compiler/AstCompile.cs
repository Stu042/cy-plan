...
public class CodeWriter {
	private StringBuilder _globalBuilder;
	private StringBuilder _scopeStartBuilder;
	private StringBuilder _currentScopeBuilder;
	public CodeWriter() {
		_globalBuilder = new StringBuilder();
		_scopeStartBuilder = new StringBuilder();
		_currentScopeBuilder = new StringBuilder();
	}
...
public class AstCompile : IAstVisitor {
	public AstCompile() { }
